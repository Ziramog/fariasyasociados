...
export default function ReviewCard({ review, variant = 'default' }) {
  ...
  return (
    <article className="relative flex flex-col h-full bg-[#EAEAEA] rounded-2xl p-5 pb-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-1.5" aria-label={`Reseña de ${review.authorName}`}>
