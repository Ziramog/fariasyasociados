    ...
    <div className="p-6 md:p-10 max-w-4xl mx-auto pb-24">
      <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        >
          {saving ? (
            <>
              <div className="w-4 h-4 border-2 border-[#3B3B3B]/30 border-t-white rounded-full animate-spin" />
              Guardando...
            </>
          ) : (
            'Guardar Cambios'
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
            <div className="md:col-span-2">
              <InputField 
                ...
                name="aboutTitle" 
                description="Ejemplo: Farias & Asociados"
              />
            </div>
            <div className="md:col-span-2">
              <InputField 
        ...
        <div className="bg-[#121217] p-6 md:p-8 rounded-2xl border border-purple-900/20 shadow-xl relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
            <InputField 
              ...
              name="analyticsId" 
              description="Solo el código (Ej: ). Déjalo en blanco para desactivar."
            />
            <InputField 
      ...
      <div className="mt-12 flex justify-end">
        ...
        >
          {saving ? (
            <>
              <div className="w-5 h-5 border-2 border-[#3B3B3B]/30 border-t-white rounded-full animate-spin" />
              Guardando...
            </>
          ) : (
            'Guardar Cambios'
