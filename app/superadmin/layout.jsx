    ...
    <div className="min-h-screen flex bg-black">
      ...
      <aside className="fixed bottom-0 md:top-0 md:left-0 md:bottom-auto w-full md:w-[260px] md:h-screen bg-[#0f0f13] md:border-r border-purple-900/30 z-50 flex md:flex-col shadow-[0_-4px_20px_rgba(0,0,0,0.5)] md:shadow-none">
        ...
        <nav className="flex-1 px-4 md:px-5 py-3 md:py-8 flex flex-row md:flex-col justify-around md:justify-start gap-2 overflow-x-auto overflow-y-hidden md:overflow-y-auto no-scrollbar">
          <Link 
            href="/superadmin" 
            className={`flex items-center gap-3 px-4 py-3 md:py-3.5 rounded-xl transition-all duration-300 min-w-max md:min-w-0 ${pathname === '/superadmin' ? 'bg-purple-600/20 text-purple-300 border border-purple-500/20 shadow-[0_0_15px_rgba(147,51,234,0.1)]' : 'text-zinc-500 hover:bg-[#1C1C1A]/5 hover:text-zinc-300'}`}
          >
          ...
          <Link 
            ...
            className={`flex items-center gap-3 px-4 py-3 md:py-3.5 rounded-xl transition-all duration-300 min-w-max md:min-w-0 ${pathname.includes('/superadmin/backups') ? 'bg-purple-600/20 text-purple-300 border border-purple-500/20 shadow-[0_0_15px_rgba(147,51,234,0.1)]' : 'text-zinc-500 hover:bg-[#1C1C1A]/5 hover:text-zinc-300'}`}
          >
          ...
          <Link 
            ...
            className={`flex items-center gap-3 px-4 py-3 md:py-3.5 rounded-xl transition-all duration-300 min-w-max md:min-w-0 ${pathname.includes('/superadmin/content') ? 'bg-purple-600/20 text-purple-300 border border-purple-500/20 shadow-[0_0_15px_rgba(147,51,234,0.1)]' : 'text-zinc-500 hover:bg-[#1C1C1A]/5 hover:text-zinc-300'}`}
          >
          ...
          <Link 
            href="/admin" 
            className="flex items-center gap-3 px-4 py-3 md:py-3.5 rounded-xl text-zinc-500 hover:bg-[#1C1C1A]/5 hover:text-zinc-300 transition-all duration-300 min-w-max md:min-w-0"
          >
