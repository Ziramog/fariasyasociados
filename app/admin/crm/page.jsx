  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-4 md:px-6 min-h-screen">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 gap-4">
        <div>
          <h1 className="text-3xl md:text-4xl font-extrabold text-white mb-1 tracking-tight">PANEL</h1>
          <p className="text-gray-400 font-medium">Centro Operativo CRM</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-5 space-y-6">
          ...
          <div className="bg-[#111] border border-[#333] rounded-xl p-6 md:p-8 shadow-xl">
